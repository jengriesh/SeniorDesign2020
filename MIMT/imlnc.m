...
%          'hsl', 'lchab', 'hue', and 'chroma' will be treated as 'independent'
...
%       'min' selects the levels with smallest influence
%       'max' selects the levels with the largest influence
...
%
%   See also: IMCOMPOSE, IMMODIFY, IMTWEAK, IMADJUST, TONEMAP.
...
for f=1:1:size(inpict,4);
	...
	switch lower(mode)
		...
		case 'hue'
			...
			protoimage=cat(3,adjustedH*360,inpictlch(:,:,2:3));
		...
		otherwise
			disp('IMLNC: Unknown mode specified')
			return;
	end
