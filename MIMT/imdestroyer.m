    ...
    switch whichfunc
        case 1
            ...
            switch whichop
                case 1
                    rv=rand();
                    se=strel('square',ceil(15*rv));
                    com=[com sprintf('se=strel(''square'',ceil(15*%g)); \n',rv)];
                case 2
                    rv=rand();
                    se=strel('disk',ceil(15*rv));
                    com=[com sprintf('se=strel(''disk'',ceil(15*%g)); \n',rv)];
                case 3
                    rv=rand(1,2);
                    se=strel('line',ceil(15*rv(1)), ceil(90*rv(2)));
                    com=[com sprintf('se=strel(''line'',ceil(15*%g), ceil(90*%g)); \n',rv(1),rv(2))];
            end
            rv=rand(1,3);
            field=dilatemargins(inpict,ceil(rv(1:2)*20),se);
            inpict=imblend(field,inpict,rv(3)*amt,'normal');
            com=[com sprintf('field=dilatemargins(inpict,ceil([%g %g]*20),se); \n',rv(1),rv(2))];
        ...
        case 4
            ...
            switch whichop
                case 1
                    ...
                    rv=rand(1,3);
                    rate=0.2+(2-0.2).*rv(1);
                    field=imlnc(randlines(size(inpict),direction,rv(2),round(rv(3)),'walks',rate));
                    com=[com sprintf('rate=0.2+(2-0.2).*%g; \n',rv(1))];
                    com=[com sprintf('field=imlnc(randlines(size(inpict),direction,%g,round(%g),''walks'',rate)); \n',rv(2),rv(3))];
                case 2
                    rv=rand();
                    direction=1+round(rv(1));
                    com=[com sprintf('direction=1+round(%g); \n',rv(1))];
                    rv=rand(1,3);
                    rate=0.5+(2-0.5).*rv(1);
                    field=imlnc(randlines(size(inpict),direction,rv(2),round(rv(3)),'ramps',rate));
                    com=[com sprintf('rate=0.5+(2-0.5).*%g; \n',rv(1))];
                    com=[com sprintf('field=imlnc(randlines(size(inpict),direction,%g,round(%g),''ramps'',rate)); \n',rv(2),rv(3))];
                case 3
                    rv=rand();
                    direction=1+round(rv(1));
                    com=[com sprintf('direction=1+round(%g); \n',rv(1))];
                    rv=rand(1,2);
                    field=imlnc(randlines(size(inpict),direction,rv(1),round(rv(2)),'normal'));
                    com=[com sprintf('field=imlnc(randlines(size(inpict),direction,%g,round(%g),''normal'')); \n',rv(1),rv(2))];
                case 4
                ...
                case 6
                    color=rand(1,3);
                    field=colorpict(size(inpict),color);  
                    com=[com sprintf('field=colorpict(size(inpict),[%g %g %g]); \n', ...
        ...
        case 6
            ...
            switch whichop
                case 1
                    rv=rand(1,3);
                    rate=0.2+(2-0.2).*rv(1);
                    field=imlnc(randlines(size(inpict),1,rv(2),round(rv(3)),'walks',rate));
                    com=[com sprintf('rate=0.2+(2-0.2).*%g; \n',rv(1))];
                    com=[com sprintf('field=imlnc(randlines(size(inpict),1,%g,round(%g),''walks'',rate)); \n',rv(2),rv(3))];
                case 2
                    rv=rand(1,2);
                    field=imlnc(randlines(size(inpict),1,rv(1),round(rv(2)),'normal'));
                    com=[com sprintf('field=imlnc(randlines(size(inpict),1,%g,round(%g),''normal'')); \n',rv(1),rv(2))];
                case 3
                    field=inpict;
