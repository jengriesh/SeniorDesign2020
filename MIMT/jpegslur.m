...
inlines1=meanlines(shpict,1,1); % get skewed hq row offsets
inlines2=meanlines(inpict,2,1); % get hq col offsets
...
clines1=meanlines(cpict,1,1);
clines2=meanlines(cpict,2,1);
difflines1=double(inlines1)-double(clines1);
difflines2=double(inlines2)-double(clines2);    
